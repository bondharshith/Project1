...
public class UsersController {
 ...
 // Endpoint to fetch a user by Mobile Number
    ...
    @GetMapping(value="/userLogin/{mobileNumber}/{passwordHash}")
	public String login(@PathVariable String mobileNumber,@PathVariable String passwordHash) {
		return usersService.login(mobileNumber, passwordHash);
	}
}
